...
from .serializers import SubjectSerializer,CourseSerializer,CourseWithContentSerialiser
...
class CourseViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @action(detail=True,methods=['get'],serializer_class=CourseWithContentSerialiser,
